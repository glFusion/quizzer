...
'quizzerubmission'    => 'New Form Submission: %s',
...
'hlp_fld_order' => 'The Order indicates where the item will appear on quizzer relative to other items, and may be changed later.',
