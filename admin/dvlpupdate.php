...
if (!SEC_inGroup('Root')) {
    ...
    Log::write(
        'system',
        Log::ERROR,
        "Someone has tried to access the Quizzer Development Code Upgrade Routine without proper permissions.  User id: {$_USER['uid']}, Username: {$_USER['username']}, IP: " . $_SERVER['REMOTE_ADDR']
    );
